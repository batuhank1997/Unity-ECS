...
public partial class GameContext {
    ...
    public GameEntity ınputEntity { get { return GetGroup(GameMatcher.Input).GetSingleEntity(); } }
    public InputComponent ınput { get { return ınputEntity.ınput; } }
    public bool hasInput { get { return ınputEntity != null; } }
    ...
    public GameEntity SetInput(UnityEngine.Vector3 newValue) {
        if (hasInput) {
            throw new Entitas.EntitasException("Could not set Input!\n" + this + " already has an entity with InputComponent!",
                "You should check if the context already has a ınputEntity before setting it or use context.ReplaceInput().");
        }
